...
SCANVI_embed_ref <- function(anndata_filename = 'PBMC_GBM_BM_preprocessed_anndata.h5ad',
  ...
  scanvae = scvi$model$SCANVI$from_scvi_model(vae, "Unknown")
...
SCANVI_embed_ref(anndata_filename = 'training_combined_6_datasets_RNA_preprocessed_anndata_pure_SCANVI_latent_128dim_20240413.h5ad',
                 save_reference_latent_file = 'training_combined_6_datasets_RNA_ref_pure_SCANVI_latent_128dim_representations_20240413.csv',
                 ref_model_path = 'demo_scanvi/training_combined_6_datasets_RNA_pure_SCANVI_latent_128dim_20240413/',
                 save_top_1000_HVGs_file = 'top_1000_HVGs_training_combined_6_datasets_RNA_pure_SCANVI_latent_128dim_20240413.csv')
