...
SCANVI_embed_ref <- function(anndata_filename = 'PBMC_GBM_BM_preprocessed_anndata.h5ad',
  ...
  RNA <- FindVariableFeatures(RNA, selection.method = "vst", assay = "RNA", nfeatures = 10702)
  top1000 <- head(VariableFeatures(RNA, assay = "RNA"), 10702)
  RNA <- RNA[top1000]
  print(RNA)
...
SCANVI_embed_ref(anndata_filename = 'training_combined_6_datasets_RNA_preprocessed_anndata_SCANVI_latent_128dim_top_10702_HVGs_all_RNA_features_20230331.h5ad',
                 save_reference_latent_file = 'training_combined_6_datasets_RNA_ref_SCANVI_latent_128dim_representations_top_10702_HVGs_all_RNA_features_20230331.csv',
                 ref_model_path = 'demo_scanvi/training_combined_6_datasets_RNA_SCANVI_latent_128dim_top_HVGs_all_10702_RNA_features_20230331/',
                 save_top_1000_HVGs_file = 'top_10702_HVGs_all_RNA_features_training_combined_6_datasets_RNA_SCANVI_latent_128dim_20230331.csv')
