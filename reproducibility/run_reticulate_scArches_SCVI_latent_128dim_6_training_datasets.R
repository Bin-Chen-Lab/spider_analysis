...
SCVI_embed_ref(anndata_filename = 'training_combined_6_datasets_RNA_preprocessed_anndata_SCVI_latent_128dim_20240410.h5ad',
                 save_reference_latent_file = 'training_combined_6_datasets_RNA_ref_SCVI_latent_128dim_representations_20240410.csv',
                 ref_model_path = 'demo_scvi/training_combined_6_datasets_RNA_SCVI_latent_128dim_20240410/',
                 save_top_1000_HVGs_file = 'top_1000_HVGs_training_combined_6_datasets_RNA_SCVI_latent_128dim_20240410.csv')
